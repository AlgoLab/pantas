...
rule suppa2:
    ...
    output:
        outd=directory(pjoin(ODIR, "salmon_suppa", "suppa2_res")),
        suppa=pjoin(ODIR, "salmon_suppa", "suppa2_res", "DIFF.dpsi"),
    params:
...
rule parse_suppa2:
    ...
    params:
        p_value = p_value
    output:
        csv=pjoin(ODIR, "salmon_suppa", "suppa.csv"),
    script: "../scripts/build_suppa.py"
